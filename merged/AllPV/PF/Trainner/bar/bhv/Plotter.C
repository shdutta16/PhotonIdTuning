...
void Plotter(){
  ...
  TH1F *SieaftM  = new TH1F("SieaftM","Sieie cut only",100,0,250); 
  TH1F *ToEaftM  = new TH1F("ToEaftM","HoE cut only",100,0,250); 
  TH1F *IsoPaftM = new TH1F("IsoPaftM","IsoP cut only",100,0,250); 
  TH1F *IsoCaftM = new TH1F("IsoCaftM","IsoC cut only",100,0,250); 
  TH1F *IsoNaftM = new TH1F("IsoNaftM","IsoN cut only",100,0,250); 

  TH1F *SieaftT  = new TH1F("SieaftT","Sieie cut only",100,0,250); 
  TH1F *ToEaftT  = new TH1F("ToEaftT","HoE cut only",100,0,250); 
  TH1F *IsoPaftT = new TH1F("IsoPaftT","IsoP cut only",100,0,250); 
  TH1F *IsoCaftT = new TH1F("IsoCaftT","IsoC cut only",100,0,250); 
  TH1F *IsoNaftT = new TH1F("IsoNaftT","IsoN cut only",100,0,250); 


  TH1F *Sieaftb  = new TH1F("Sieaftb","Sieie cut only",100,0,250); 
  TH1F *ToEaftb  = new TH1F("ToEaftb","HoE cut only",100,0,250); 
  TH1F *IsoPaftb = new TH1F("IsoPaftb","IsoP cut only",100,0,250); 
  TH1F *IsoCaftb = new TH1F("IsoCaftb","IsoC cut only",100,0,250); 
  TH1F *IsoNaftb = new TH1F("IsoNaftb","IsoN cut only",100,0,250); 

  TH1F *SieaftN  = new TH1F("SieaftN","Sieie cut only",180,0,180); 
  TH1F *ToEaftN  = new TH1F("ToEaftN","HoE cut only",180,0,180); 
  TH1F *IsoPaftN = new TH1F("IsoPaftN","IsoP cut only",180,0,180); 
  TH1F *IsoCaftN = new TH1F("IsoCaftN","IsoC cut only",180,0,180); 
  TH1F *IsoNaftN = new TH1F("IsoNaftN","IsoN cut only",180,0,180); 

  TH1F *SieaftbN  = new TH1F("SieaftbN","Sieie cut only",180,0,180); 
  TH1F *ToEaftbN  = new TH1F("ToEaftbN","HoE cut only",180,0,180); 
  TH1F *IsoPaftbN = new TH1F("IsoPaftbN","IsoP cut only",180,0,180); 
  TH1F *IsoCaftbN = new TH1F("IsoCaftbN","IsoC cut only",180,0,180); 
  TH1F *IsoNaftbN = new TH1F("IsoNaftbN","IsoN cut only",180,0,180); 
  ...
  TH1F *EffPTMs = (TH1F*)input->Get("EffPTMs");
  TH1F *EffPTMt = (TH1F*)input->Get("EffPTMt");
  TH1F *EffPTMp = (TH1F*)input->Get("EffPTMp");
  TH1F *EffPTMc = (TH1F*)input->Get("EffPTMc");
  TH1F *EffPTMn = (TH1F*)input->Get("EffPTMn");

  TH1F *EffPTTs = (TH1F*)input->Get("EffPTTs");
  TH1F *EffPTTt = (TH1F*)input->Get("EffPTTt");
  TH1F *EffPTTp = (TH1F*)input->Get("EffPTTp");
  TH1F *EffPTTc = (TH1F*)input->Get("EffPTTc");
  TH1F *EffPTTn = (TH1F*)input->Get("EffPTTn");


  TH1F *EffPTbs = (TH1F*)input->Get("EffPTbs");
  TH1F *EffPTbt = (TH1F*)input->Get("EffPTbt");
  TH1F *EffPTbp = (TH1F*)input->Get("EffPTbp");
  TH1F *EffPTbc = (TH1F*)input->Get("EffPTbc");
  TH1F *EffPTbn = (TH1F*)input->Get("EffPTbn");
  ...
  Metas->GetXaxis()->SetRangeUser(-3.0,3.0);
  ...
  Tetas->GetXaxis()->SetRangeUser(-3.0,3.0);
  ...
  IsoPaftT->SetMarkerColor(kGreen);
  IsoPaft->GetYaxis()->SetTitle("Only Iso P Cut Efficiency");
  IsoPaft->GetXaxis()->SetTitle("Pt GeVc^{-1}");
  ...
  IsoCaftT->SetMarkerColor(kGreen);
  ...
  IsoNaftT->SetMarkerColor(kGreen);
  IsoNaft->GetYaxis()->SetTitle("Only Iso P Cut Efficiency");
  IsoNaft->GetXaxis()->SetTitle("Pt GeVc^{-1}");


  c20->SaveAs("BranchOutCutsSignalWP.png");
  c20->SaveAs("BranchOutCutsSignalWP.C");
  c20->SaveAs("BranchOutCutsSignalWP.root");
  ...
  c11->SaveAs("BranchOutCutsNVTX.C");
  c11->SaveAs("BranchOutCutsNVTX.root");
  ...
  c12->SaveAs("BranchOutCutsEta.C");
  c12->SaveAs("BranchOutCutsEta.root");
